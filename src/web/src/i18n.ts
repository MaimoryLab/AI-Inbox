...
const storageKey = "ai-index.locale";
...
export const appText = {
  "zh-CN": {
    ...
    english: "English",
    sourceSettings: "来源",
    sourceSettingsDescription: "选择 AI-Index 扫描本地 Agent 会话的位置。",
    ...
    clearTodoCardsDescription: "删除所有 Todo 卡片、证据、任务链和整理历史；来源会话不会被删除。",
  ...
  "en-US": {
    ...
    sourceSettingsDescription: "Choose where AI-Index scans local agent sessions.",
...
const errorMessages: Record<Locale, Record<string, string>> = {
  "zh-CN": {
    ...
    organize_in_progress: "整理仍在进行，请等待当前任务完成。",
  ...
  "en-US": {
    ...
    organize_in_progress: "Organize is still running. Wait for the current task to finish.",
