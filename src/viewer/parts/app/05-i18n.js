    var I18N_MESSAGES = {
      en: {
        ...
        'act.extract.timeout': 'Provider timed out; showing existing todos',
        'act.extract.configError': 'LLM config needs attention; showing existing todos',
        'act.extract.providerError': 'LLM provider unavailable; showing existing todos',
        'act.extract.runningExisting': 'Still organizing from a previous request...',
        ...
        'settings.subtitle': 'Local configuration is written to the user config file and applies to the next organize run.',
        'settings.close': 'Close',
        'settings.language': 'UI language',
        'settings.extractor': 'LLM extraction config',
        'settings.maxLlmSessions': 'Max LLM sessions per organize run',
        ...
        'settings.savedRestart': 'Config saved. It applies to the next organize run.',
      ...
      zh: {
        ...
        'act.extract.timeout': '上游超时，已显示现有待办',
        'act.extract.configError': '大模型配置需要检查，已显示现有待办',
        'act.extract.providerError': '大模型服务不可用，已显示现有待办',
        'act.extract.runningExisting': '上一次整理仍在进行...',
        ...
        'settings.title': '设置',
        'settings.subtitle': '本机配置会写入用户配置文件，下次整理时生效。',
        'settings.close': '关闭',
        'settings.language': '界面语言',
        'settings.extractor': '大模型抽取配置',
        'settings.maxLlmSessions': '每次整理最多调用大模型的会话数',
        ...
        'settings.save': '保存配置',
        'settings.saving': '保存中...',
        'settings.savedRestart': '配置已保存，下次整理时生效。',
