...
export const adapter: ConnectAdapter = {
  ...
  docs: "https://github.com/MaimoryLab/agentmemory-lab#codex-cli-codex-plugin-platform",
  protocolNote:
  ...
  async install(opts: ConnectOptions): Promise<ConnectResult> {
    ...
    p.log.info(
      "Codex picks up MCP servers on next launch. For the deeper plugin install, run: codex plugin marketplace add MaimoryLab/agentmemory-lab && codex plugin add agentmemory@agentmemory",
    );
